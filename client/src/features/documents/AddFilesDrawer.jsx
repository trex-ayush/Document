 ...
 * crop editor open on top — Escape belongs to them), onUpload(), onCancel()
 */
export default function AddFilesDrawer({ isOpen, files, picker, busy = false, onUpload, onCancel }) {
    ...
    <Drawer
      ...
      footer={
        <>
          ...
          <Button onClick={onUpload} disabled={!queue.length || detecting} leftIcon={<Upload className="h-4 w-4" aria-hidden="true" />}>
