...
const CARD =
  'relative block overflow-hidden rounded-2xl border border-neutral-200 bg-white px-4 py-3.5 shadow-soft-xs sm:px-5 sm:py-4 lg:px-6 dark:border-neutral-700 dark:bg-neutral-800';
const INTERACTIVE =
...
function SubLine({ sub, tone }) {
  ...
  return (
    <p className="mt-2 truncate text-sm sm:mt-2.5">
      {isParts ? (
        <>
  ...
  const body = (
    <>
      ...
      <div className="relative min-w-0 pr-16 sm:pr-24">
        ...
        <div aria-hidden="true" className="mt-2 w-full max-w-40 border-t border-dotted border-neutral-300 sm:mt-2.5 dark:border-neutral-600" />
