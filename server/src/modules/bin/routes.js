...
import { listBinEntries, restoreDocument, restoreFolder, restoreItem } from './lib.js';

// Family-scoped Bin (docs/DECISIONS.md "Soft delete / recycle bin"): lists this family's
// soft-deleted documents/folders/items and lets any WRITE member restore one. Permanent deletion
...
const typeEnum = z.enum(['document', 'folder', 'item']);
